...
<div class="o-membership-form">
	<div class="u-1/4">
		...
		<div class="u-radio"><span class='radio'>
		<input type="radio" name="Communications[]" id="Form_MembershipForm_Comm_1_`+ members +`" value="Email" />
		<label for="Form_MembershipForm_Comm_1_`+ members +`"><span></span> Monthly E-Newsletter (no fee)</label>
		</span> &nbsp; &nbsp;
		<span class='radio'>
		<input type="radio" name="Communications[]" id="Form_MembershipForm_Comm_2_`+ members +`" value="Print" />
		<label for="Form_MembershipForm_Comm_2_`+ members +`"><span></span> Printed & Posted Newsletter ($10)</label>
		</span>
		</div>
	</div>
</div>
